...
if.end:                                           ; preds = %err.ok10, %err.ok3
  ret void

if.then:                                          ; preds = %entry
  %3 = load { i32, i64 }, ptr %person1, align 4
  %4 = extractvalue { i32, i64 } %3, 1
  %5 = inttoptr i64 %4 to ptr
  %6 = load { ptr, i64 }, ptr %5, align 8
  %narrowed.local = alloca { ptr, i64 }, align 8
  store { ptr, i64 } %6, ptr %narrowed.local, align 8
  %7 = load { ptr, i64 }, ptr %narrowed.local, align 8
  %8 = extractvalue { ptr, i64 } %7, 0
  %9 = extractvalue { ptr, i64 } %7, 1
  call void @sere_write(ptr %8, i64 %9)
...
if.next:                                          ; preds = %entry
  %12 = load { i32, i64 }, ptr %person1, align 4
  %13 = extractvalue { i32, i64 } %12, 1
  %14 = inttoptr i64 %13 to ptr
  %narrowed.local4 = alloca %Person, align 8
  store ptr %14, ptr %narrowed.local4, align 8
  %15 = call { ptr, i64 } @Person_get_name(ptr %narrowed.local4)
...
err.ok6:                                          ; preds = %if.next
  %20 = extractvalue { ptr, i64 } %15, 0
  %21 = extractvalue { ptr, i64 } %15, 1
  call void @sere_write(ptr %20, i64 %21)
  call void @sere_write_nl()
  %22 = call i32 @sere_has_error()
  %23 = icmp ne i32 %22, 0
  br i1 %23, label %err7, label %err.ok8
...
err.ok8:                                          ; preds = %err.ok6
  ...
  %25 = icmp ne i32 %24, 0
  br i1 %25, label %err9, label %err.ok10
...
entry:
  ...
  store { ptr, i64 } { ptr @2, i64 3 }, ptr %union.str, align 8
  %0 = ptrtoint ptr %union.str to i64
  %1 = insertvalue { i32, i64 } { i32 1, i64 undef }, i64 %0, 1
  call void @print_name({ i32, i64 } %1)
  %2 = call i32 @sere_has_error()
  %3 = icmp ne i32 %2, 0
...
err.ok:                                           ; preds = %entry
  ...
  %4 = getelementptr inbounds nuw %Person, ptr %init.tmp, i32 0, i32 0
  store i32 -1016140896, ptr %4, align 4
  call void @Person___init__(ptr %init.tmp, { ptr, i64 } { ptr @3, i64 5 })
  %5 = load %Person, ptr %init.tmp, align 8
...
err.ok2:                                          ; preds = %err.ok
  ...
  store %Person %5, ptr %union.record, align 8
  %8 = ptrtoint ptr %union.record to i64
  %9 = insertvalue { i32, i64 } { i32 0, i64 undef }, i64 %8, 1
  call void @print_name({ i32, i64 } %9)
  %10 = call i32 @sere_has_error()
  %11 = icmp ne i32 %10, 0
