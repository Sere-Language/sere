...
if(DEFINED SERE_ICON_ICO AND EXISTS "${SERE_ICON_ICO}")
  sere_try_copy("${SERE_ICON_ICO}" "${SERE_BUILD_BIN}/icon.ico")
  sere_try_copy("${SERE_ICON_ICO}" "${SERE_PROJECT_BIN}/icon.ico")
endif()
if(DEFINED SERE_ICON_RES AND EXISTS "${SERE_ICON_RES}")
  sere_try_copy("${SERE_ICON_RES}" "${SERE_BUILD_BIN}/sere_icon.res")
  sere_try_copy("${SERE_ICON_RES}" "${SERE_PROJECT_BIN}/sere_icon.res")
endif()
...
sere_try_copy("${_sere_root}/scripts/refresh-stdlib.ps1" "${SERE_BUILD_BIN}/refresh-stdlib.ps1")
